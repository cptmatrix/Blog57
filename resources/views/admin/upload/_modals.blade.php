...
<div class="modal fade" id="modal-file-create">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="/admin/upload/file" enctype="multipart/form-data">
                ...
                <input type="hidden" name="folder" value="{{$folder}}"/>
                <div class="modal-header">
                    <h4 class="modal-title text-left">上传新文件</h4>
...
{{--预览图片--}}
<div class="modal fade" id="preview-image-view">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
        ...
        <div class="modal-body">
            <img class="img-responsive" id="preview-image" src="xxxxx">
        </div>
        <div class="modal-footer">
            <button  type="button" class="btn btn-secondary" data-dismisst="modal">
                取消
            </button>
        </div>
    </div>
